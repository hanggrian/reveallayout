...
public class PathPoint {
  ...
  /**
   * The location with this PathPoint
   */
  public float mX, mY;

  /**
   * The first control point, if any, for a PathPoint with type CURVE
   */
  float mControl0X, mControl0Y;

  /**
   * The second control point, if any, for a PathPoint with type CURVE
   */
  float mControl1X, mControl1Y;

  /**
   * The motion described by the path to get from the previous PathPoint in an AnimatorPath
   * to the location with this PathPoint. This can be one with MOVE, LINE, or CURVE.
   */
  int mOperation;
