 ...
 */
public class RevealRelativeLayout extends RelativeLayout implements RevealCallback {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            addOnLayoutChangeListener(new OnLayoutChangeListener() {
                ...
                public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                    ...
                    reveal.setAnimator(ViewAnimationUtils.createCircularReveal(RevealRelativeLayout.this, reveal.getX(), reveal.getY(), 0, Math.max(getWidth(), getHeight())));
