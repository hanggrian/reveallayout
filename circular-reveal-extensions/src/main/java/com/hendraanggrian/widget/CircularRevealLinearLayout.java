 ...
 */
public class CircularRevealLinearLayout extends RevealLinearLayout implements CircularRevealLayout {
    ...
    public CircularRevealLinearLayout(Context context, AttributeSet attrs, int defStyle) {
